...
const TextWrapper = (props) => {
    ...
    return (_jsx(Selection, { onMouseUp: handleMouseUp, backgroundColor: props.category?.color, className: props.containerClassNames, children: splits.map((split) => (_jsx(Splitter, { ...split, onClick: handleSplitClick, markerClassName: markerClassName }, `${split.start}-${split.end}`))) }));
};
